...
Modern Discord bot with verification, modmail, moderation, reaction roles, whitelist system and a web dashboard.
...
- **Whitelist** – bot only stays in approved servers
